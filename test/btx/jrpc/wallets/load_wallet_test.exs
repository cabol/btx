defmodule BTx.JRPC.Wallets.LoadWalletTest do
  ...
  alias BTx.JRPC.Wallets.{LoadWallet, LoadWalletResult}
  ...
  describe "(RPC) Wallets.load_wallet/3" do
    ...
    test "handles wallet already loaded error", %{client: client} do
      ...
      assert {:error, %BTx.JRPC.MethodError{code: -4, message: message}} =
               Wallets.load_wallet(client, filename: "test.dat")
