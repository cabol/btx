defmodule BTx.JRPC.Wallets.UnloadWalletResultTest do
  ...
  alias BTx.JRPC.Wallets.{CreateWalletResult, UnloadWalletResult}
  ...
  describe "(RPC) Wallets.unload_wallet/3" do
    ...
    test "real Bitcoin regtest integration" do
      ...
      assert {:error, %BTx.JRPC.MethodError{code: -18}} =
