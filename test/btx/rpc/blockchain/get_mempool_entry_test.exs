defmodule BTx.RPC.Blockchain.GetMempoolEntryTest do
  ...
  alias BTx.RPC.{Blockchain, Encodable, Request, Wallets}
  alias BTx.RPC.Blockchain.{GetMempoolEntry, GetMempoolEntryResult}
  ...
  describe "(RPC) Blockchain.get_mempool_entry/3" do
    ...
    test "real Bitcoin regtest integration" do
      ...
      assert_eventually do
        ...
        assert %BTx.RPC.Blockchain.GetMempoolEntryFees{} = result.fees
