    ...
    [
      ...
      groups_for_modules: [
        ...
        "Wallet RPCs": [
          ...
          BTx.RPC.Wallets.GetBalances,
          BTx.RPC.Wallets.GetBalancesResult,
          BTx.RPC.Wallets.GetBalancesDetail,
          ...
          BTx.RPC.Wallets.ImportDescriptorRequest,
          BTx.RPC.Wallets.ImportDescriptorResponse,
          BTx.RPC.Wallets.ImportDescriptors,
          BTx.RPC.Wallets.ImportDescriptorsResult,
          BTx.RPC.Wallets.ListTransactions,
          BTx.RPC.Wallets.ListTransactionsItem,
          BTx.RPC.Wallets.ListUnspent,
          BTx.RPC.Wallets.ListUnspentQueryOptions,
          ...
          BTx.RPC.Wallets.SignRawTransactionWithWallet,
          BTx.RPC.Wallets.SignRawTransactionWithWalletResult,
