defmodule BTx.RPC.RawTransactions.SignRawTransactionWithKeyResult do
  @moduledoc """
  Result from the `signrawtransactionwithkey` JSON RPC API.
  ...
  @typedoc "SignRawTransactionWithKeyResult"
  @type t() :: %__MODULE__{
          hex: String.t() | nil,
  ...
  @doc """
  Creates a new `SignRawTransactionWithKeyResult` schema.
  """
  @spec new(Response.result()) :: {:ok, t()} | {:error, Ecto.Changeset.t()}
  def new(attrs) when is_map(attrs) do
    %__MODULE__{}
    |> changeset(attrs)
    |> apply_action(:signrawtransactionwithkey_result)
  end
  ...
  @doc """
  Creates a changeset for the `SignRawTransactionWithKeyResult` schema.
  """
